...
for i, m in enumerate(methods):
    ...
    for j, size in enumerate(sizes):
        ...
        # Log2 ratio: positive means Custom is faster (JDK took longer)
        ratio = np.log2(native_val / custom_val)
...
sns.heatmap(
    ...
    ax=ax,
    cbar_kws={
        'label': '← JDK Faster (ArrayDeque) | Relative Speedup Scale (Clipped at 16x) | Custom Faster (CustomArrayDeque) →'
    },
    linewidths=0.6,
    linecolor='#444444',
...
ax.set_title(
    ...
    '(Positive/Blue = CustomArrayDeque Faster, Negative/Red = ArrayDeque Faster)',
...
print("ArrayDeque performance heatmap generated successfully!")
